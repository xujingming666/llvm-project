...
#ifndef LLVM_DUMMY_DUMMYTARGETLOWERING_H
#define LLVM_DUMMY_DUMMYTARGETLOWERING_H
...
class DummyTargetLowering : public TargetLowering {
  const DummySubtarget &Subtarget;
public:
  explicit DummyTargetLowering(const DummyTargetMachine &TM,
...
#endif // LLVM_DUMMY_DUMMYTARGETLOWERING_H
